This repository contains the implementation of a machine learning pipeline for classifying heart sound recordings into one of three categories: Healthy, Murmur, or Artifact.
